...
export default function GameDetails() {
    const { userId, deleteGame} = useContext(AuthContext);
    ...
    const onCommentSubmit = async (e) => {
       ...
       const result = await gameService.addComment(gameId, {
        ...
        setGame(s => ({...s, comments: {...s.comments, [result._id]: result }}));
        setUsername('');
        setComment('');
    }
...
<section id="game-details">
    ...
    <article className="create-comment">
        ...
        <form className="form" onSubmit={onCommentSubmit}>
            <input type="text" name='username' placeholder="Kiro Breaka" value={username} onChange={(e) => setUsername(e.target.value)}/>
